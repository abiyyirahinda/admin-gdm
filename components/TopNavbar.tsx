...
import { Add, CalendarEdit, DirectNotification, Logout, SearchNormal1 } from "iconsax-react";
    ...
    <>
      <PageNavbar>
        ...
        <PageNavbarRightContent>
          ...
          <PageNavbarPrimaryButton onClick={() => signOut()} className="h-8 gap-1 bg-primary hidden py-1 px-2 duration-200 text-white rounded-lg text-xs md:flex items-center justify-center">
            <Logout size={16} />
